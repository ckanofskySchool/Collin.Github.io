...
alt: Robopack electronics setup
...
I am planning to use CIM motors which I've used extensively with my robotics teams. The reason for using a CIM motor is due to low cost sitting at around $17, and the output it produces being 5,330 RPM with 21.33 in/lbs of torque, which is powerful and should definitely ensure a job well done.
...
<!-- Photo needed: wiring layout on the bench -->
...
<!-- Photo needed: laser-cut electronics panel with components attached -->
